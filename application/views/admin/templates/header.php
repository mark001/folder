...
<html lang="en">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="nav navbar-nav navbar-right">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="/folder/administrator/accounts/edit/<?php echo $this->session->userdata('username'); ?>"><i class="fa fa-user"></i> Profile</a></li>
  ...
  <div class="col-sm-3 col-md-2 sidebar">
    <ul class="nav nav-sidebar">
      ...
      <li class="<?php echo @$report; ?>"><a href="/folder/administrator/reports"><i class="fa fa-bug"></i> Reports <?php if ($unread != 0) { ?><span class="badge"><?php echo $unread ?></span><?php } ?></a></li>  
    </ul>
